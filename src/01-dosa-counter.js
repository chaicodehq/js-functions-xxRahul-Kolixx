...
export function calculateDosaOrder(type, quantity = 1, isSpicy = false) {
  // Your code here
  if(typeof type !== 'string' || type.trim().length === 0 || quantity <=0) return null
  ...
  switch(type){
    case "plain": basePrice=40
                 break;
    case "masala": basePrice=60
                   break;
    case "onion": basePrice=50
                   break;
    case "butter": basePrice=70
                   break;
    case  "paper": basePrice=90
                   break;
    case "cheese": basePrice=80
                   break;
    default : return null
  }
